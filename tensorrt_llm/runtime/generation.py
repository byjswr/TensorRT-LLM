...
class GenerationSession(object):
    ...
    def __init__(self,
        ...
        self.nl, self.fl, self.ll = self.get_transformer_layers(self.mapping, self._model_config.num_layers)
    ...
    def get_transformer_layers(self, mapping, num_layers):
        ...
        return layers_per_pipeline_stage + offset, mapping.pp_rank * layers_per_pipeline_stage + offset_pre, (mapping.pp_rank + 1) * layers_per_pipeline_stage + offset_pre + offset
    ...
    def _get_context_shape_buffer(
        ...
        if self.has_position_embedding and self.mapping.is_first_pp_rank():
